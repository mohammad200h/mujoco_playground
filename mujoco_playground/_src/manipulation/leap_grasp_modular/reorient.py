...
from mujoco_playground._src.manipulation.leap_grasp import base as leap_grasp_base
...
class CubeReorient(leap_grasp_base.LeapHandEnv):
  ...
  def reset(self, rng: jax.Array) -> mjx_env.State:
    ...
    goal_quat = leap_grasp_base.uniform_quat(goal_rng)
    ...
    start_quat = leap_grasp_base.uniform_quat(quat_rng)
  ...
  def _get_obs(
    ...
    rand_quat = leap_grasp_base.uniform_quat(key1)
